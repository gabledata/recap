...
def test_primitive_types(hive_client):
    ...
    assert fields[0].extra_attrs["comment"] == "c4"
    ...
    assert fields[1].extra_attrs["comment"] == "c5"
    ...
    assert fields[2].extra_attrs["comment"] == "c6"
    ...
    assert fields[3].extra_attrs["comment"] == "c7"
    ...
    assert fields[4].extra_attrs["comment"] == "c8"
    ...
    assert fields[5].extra_attrs["comment"] == "c9"
    ...
    assert fields[6].extra_attrs["comment"] == "c10"
    ...
    assert fields[7].extra_attrs["comment"] == "c11"
    ...
    assert fields[8].extra_attrs["comment"] == "c12"
    ...
    assert fields[9].extra_attrs["comment"] == "c13"
    ...
    assert fields[10].extra_attrs["comment"] == "c14"
...
def test_parameterized_types(hive_client):
    ...
    assert fields[0].extra_attrs["comment"] == "c16"
    ...
    assert fields[1].extra_attrs["comment"] == "c17"
    ...
    assert fields[2].extra_attrs["comment"] == "c18"
    ...
    assert fields[3].extra_attrs["comment"] == "c19"
    ...
    assert fields[4].extra_attrs["comment"] == "c20"
    ...
    assert fields[5].extra_attrs["comment"] == "c21"
    ...
    assert fields[6].extra_attrs["comment"] == "c22"
